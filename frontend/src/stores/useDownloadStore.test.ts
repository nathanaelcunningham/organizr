...
describe('useDownloadStore', () => {
  ...
  describe('createDownload', () => {
    it('should create download and add to list', async () => {
      ...
      expect(mockAddNotification).toHaveBeenCalledWith('success', 'Download started successfully')
    })
  ...
  describe('computed getters', () => {
    ...
    it('getActiveDownloads should return queued, downloading, and organizing', () => {
      ...
      expect(active.map((d) => d.status)).toEqual(['queued', 'downloading', 'organizing'])
    })
